...
# 在One Line脚本中获取SQL Edition，ServicePack和版本号。
#### Get SQL Edition, ServicePack, And Version Number In One Line script
**发布-日期: 2014年04月09日 (评论)**
...
## 中文
我通常将此单个脚本包含在任何企业范围的报告中以了解SQL版，Service Pack和版本号。你还可以将其插入审核表中，以检查一段时间内的版本控制。我稍后可能会写一些逻辑来讲讲所有这些。
